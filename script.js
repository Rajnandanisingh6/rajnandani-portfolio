...
function notesModal() {
  ...
  const close =
    document.getElementById("noteModalClose");

  const title =
    document.getElementById("modalNoteTitle");

  const tag =
    document.getElementById("modalNoteTag");

  const body =
    document.getElementById("modalNoteBody");

  const notes =
    document.querySelectorAll(".interactive-note");
  ...
  const noteData = {
    ...
    jwt: {
      ...
      title:
        "What I Finally Understood About JWT Authentication",
    ...
    mvc: {
      ...
      title:
        "Why My Node.js Code Started Making More Sense With MVC",
    ...
    dsa: {
      ...
      title:
        "What DSA Is Teaching Me Beyond Just Solving Questions",
    ...
    projects: {
      ...
      title:
        "Building a Project Taught Me More Than Watching Tutorials",
